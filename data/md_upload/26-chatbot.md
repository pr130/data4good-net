...
- [ChatGPT](https://civic-data.de/selbstlernmaterial/#chatgpt): ein [Chatbot](https://example.org/chatbot), der von der Firma OpenAI entwickelt wurde. ChatGPT verwendet LLM-Modelle von OpenAI.
